    ...
    public getChangeDiff(
        ...
        try {
            ...
            const msg =
                ...
                this.translate.instant('A change recommendation or amendment is probably referring to a non-existant line number.') + ' ' +
                this.translate.instant('If it is an amendment, you can back up its content when editing it and delete it afterwards.');
