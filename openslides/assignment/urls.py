...
from openslides.assignment.views import (AssignmentListView, AssignmentDetail,
    ...
    AssignmentRunOtherDeleteView, GeneratePollView, ViewPoll, AssignmentPDF,
    AssignmentPollPDF, AssignmentPollDelete, SetPublishStatusView,
