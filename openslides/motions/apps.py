...
class MotionsAppConfig(AppConfig):
    ...
    def ready(self):
        ...
        from .views import CategoryViewSet, MotionViewSet, MotionPollViewSet, WorkflowViewSet, SubmittersRelationshipViewSet
        ...
        router.register(self.get_model('SubmittersRelationship').get_collection_string(), SubmittersRelationshipViewSet)
